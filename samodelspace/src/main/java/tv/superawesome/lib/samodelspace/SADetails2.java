 ...
 */
public class SADetails2 implements Parcelable, JSONSerializable {
    public int width;
    public int height;
    public String name;
    ...
    protected SADetails2(Parcel in) {
        width = in.readInt();
        height = in.readInt();
        name = in.readString();
    ...
    public SADetails2 (JSONObject jsonObject) {
        readFromJson(jsonObject);
    }

    public static final Creator<SADetails2> CREATOR = new Creator<SADetails2>() {
        @Override
        public SADetails2 createFromParcel(Parcel in) {
            return new SADetails2(in);
        }

        @Override
        public SADetails2[] newArray(int size) {
            return new SADetails2[size];
        }
    };
